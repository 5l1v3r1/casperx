        ...
        if self.options.isalive <= 0:
            ...
            if self.next_isalive == True:
                ...
                if str(self.errors_isalive) >= str(self.options.isalive):
                    self.report("---------------------")
                    self.report("\nAlive System: CasperX is checking if your target still alive. [Waiting for reply...]\n")
    ...
    def _get_attack_urls(self):
        ...
        if options.update:
            ...
            try:
                ...
                print("$ git clone https://github.com/dhanumurti/casperx\n")
            return []
